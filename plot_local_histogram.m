function stats = plot_local_histogram(filename, depth=14, acc_fact = 5, kernel_size=3, h=480, w=640, steps = 1, show_fig = true)
    #
    ...
    [ker_histo, medians_vector] = kernel_histogram(img_mtx, kernel_size, depth, steps);
...
function [ker_histo, med_vct] = kernel_histogram(img_mtx, kernel_size=3, depth=14, steps=1)
    #
